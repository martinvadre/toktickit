...
p_body("Project Kanban : https://github.com/users/martinvadre/projects/1/views/1", size=11, space_after=12)
...
p_body("Project : https://github.com/users/martinvadre/projects/1/views/1")
