# Peer Reviewer Log - Lab 1

- **Student Name:** Martin Vadre
- **Student ID:** 6X07050XXXX
- **GitHub Username:** martinvadre
- **Peer Reviewer Name:** Magiciancat9
- **Peer Reviewer GitHub:** Magiciancat9

## Reviewed Pull Requests

| PR Link | Feature | Review Status | Comments & Feedback |
| :--- | :--- | :--- | :--- |
